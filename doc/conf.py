# -*- coding: utf-8 -*-
#
# zc.intid documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'zcintid.tex', u'zc.intid Documentation',
...
man_pages = [
    (master_doc, 'zcintid', u'zc.intid Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'zcintid', u'zc.intid Documentation',
     author, 'zcintid', 'One line description of project.',
     'Miscellaneous'),
]
...
intersphinx_mapping = {
    ...
    'http://zopekeyreference.readthedocs.io/en/latest/': None,
